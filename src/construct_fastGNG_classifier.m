function [ nodes, edges, node_classes ] = construct_fastGNG_classifier( Data, classLabels, NumOfEpochs, NumOfSamples, NumOfRepeats, lambda)
...
for kk=1:NumOfEpochs
    ...
    [nodes, edges, ages, fixed_nodes, err] = edgeManagementF(In(:,n),nodes,edges,ages,fixed_nodes,err,distances, params);

    % Step 7. Dead Node Removal Procedure.
    [nodes, edges, ages, fixed_nodes, err] = removeUnconnectedF(nodes, edges,ages,fixed_nodes,err);
