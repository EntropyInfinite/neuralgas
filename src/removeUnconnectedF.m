function [nodes, edges, ages, fixed_nodes, error] = removeUnconnectedF(nodes, edges,ages,fixed_nodes,error) %#codegen
...
while NumOfNodes >= i
    if any(edges(i,:)) == 0
        ...
        fixed_nodes = [fixed_nodes(1,1:i-1) fixed_nodes(1,i+1:NumOfNodes);];
