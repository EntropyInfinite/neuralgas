function plotgng(pos,edges,display_node_index,fixed)
...
postemp = pos(:,fixed==0);
plot3(x,y,z,'b',postemp(1,:),postemp(2,:),postemp(3,:),'.r','markersize',6)
postemp = pos(:,fixed==1);
plot3(x,y,z,'b',postemp(1,:),postemp(2,:),postemp(3,:),'.g','markersize',6)
